...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_asshai_cache` (
  `cache_key` varchar(255) NOT NULL,
  `value` longtext NOT NULL,
  `expires` datetime(6) NOT NULL,
  PRIMARY KEY (`cache_key`),
  KEY `tbl_asshai_cache_expires` (`expires`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `topic_location` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `topic_location_name_c1494956_uniq` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `topic_topic` (
  ...
  PRIMARY KEY (`douban_id`),
  KEY `topic_topic_location_id_c3e1a85c_fk_topic_location_id` (`location_id`),
  KEY `topic_topic_d5d3db17` (`title`),
  KEY `topic_topic_572d4e42` (`url`),
  KEY `topic_topic_b16a6265` (`create_time`),
  KEY `topic_topic_e0df5a99` (`update_time`),
  CONSTRAINT `topic_topic_location_id_c3e1a85c_fk_topic_location_id` FOREIGN KEY (`location_id`) REFERENCES `topic_location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
