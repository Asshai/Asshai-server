"""
Django settings for asshai project.
...
SECRET_KEY = '21r7eyy2q5(jy)&qtn3-gx$rr&%liqy_v!dz%fjbxoo$z&1ga+'
...
WSGI_APPLICATION = 'asshai.wsgi.application'
